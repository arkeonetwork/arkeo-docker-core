...
DEFAULT_PROVIDER_NAME=$(strip_quotes "${PROVIDER_NAME:-${SENTINEL_PROVIDER_NAME:-"Default Provider"}}")
DEFAULT_MONIKER=${SENTINEL_MONIKER:-"Default Provider"}
DEFAULT_WEBSITE=${SENTINEL_WEBSITE:-"http://defaultprovider.com"}
DEFAULT_DESCRIPTION=${SENTINEL_DESCRIPTION:-"Default provider description."}
DEFAULT_LOCATION=${SENTINEL_LOCATION:-"Default Location"}
DEFAULT_SOURCE_CHAIN=${SENTINEL_SOURCE_CHAIN:-"arkeo-main-v1"}
DEFAULT_FREE_RATE_LIMIT=${FREE_RATE_LIMIT:-10}
DEFAULT_FREE_RATE_LIMIT_DURATION=${FREE_RATE_LIMIT_DURATION:-"1m"}
DEFAULT_CLAIM_STORE_LOCATION=${CLAIM_STORE_LOCATION:-"/home/phil/.arkeo/0xFury/claims"}
DEFAULT_CONTRACT_CONFIG_STORE_LOCATION=${CONTRACT_CONFIG_STORE_LOCATION:-"/home/phil/.arkeo/0xFury/contract_configs"}
DEFAULT_PROVIDER_CONFIG_STORE_LOCATION=${PROVIDER_CONFIG_STORE_LOCATION:-"/home/phil/.arkeo/0xFury/provider_configs"}
