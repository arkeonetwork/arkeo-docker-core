...
DEFAULT_PROVIDER_NAME="Default Subscriber"
DEFAULT_MONIKER="Default Subscriber"
DEFAULT_WEBSITE="http://defaultSubscriber.com"
DEFAULT_DESCRIPTION="Default subscriber description."
...
# Write sentinel env file if missing
